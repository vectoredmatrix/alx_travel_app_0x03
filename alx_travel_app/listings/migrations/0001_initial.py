    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tx_id', models.CharField(blank=True, max_length=50, unique=True)),
                ('status', models.CharField(blank=True, choices=[('Pending', 'Pending'), ('Failed', 'Failed'), ('Completed', 'Completed')], max_length=20)),
